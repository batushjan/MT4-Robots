...
void OnInit()
{
   ...
   StopLoss[0] = StopLevel;
   StopLoss[1] = StopLevel;
   StopLoss[2] = StopLevel;
   StopLoss[3] = StopLevel;
   StopLoss[4] = StopLevel;

   TakeProfit[0] = StopLevel;
   TakeProfit[1] = StopLevel;
   TakeProfit[2] = StopLevel;
   TakeProfit[3] = StopLevel;
   TakeProfit[4] = StopLevel;
